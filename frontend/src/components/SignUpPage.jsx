...
function SignUpPage() {
    return (
        <div className='relative bg-white/40 sm:mx-56 h-[90vh]  top-10 left-0 right-0 rounded-lg border   mx-1 flex flex-col items-center  justify-center backdrop-blur-lg  white/90 '>
            ...
            <form className='flex flex-col text-center items-center justify-center'>
                ...
                <div className='flex items-center  w-[65%] '>
                    <input type="checkbox" className='inline-block rouded-full self-center relative top-0' required /> <p className='text-sm'>I agree to <span className='text-green-500 font-semibold'>Food store</span> 's Terms of Service, <span className='font-semibold'>Privacy Policy </span> and <span className='font-semibold'>Content Policies</span> </p>
                </div>

                <button className=' border rounded-lg px-10 my-3 border-blue-500 bg-blue-700'>Sign Up </button>
            </form>
        </div>
    )
}
